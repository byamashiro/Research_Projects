...
sed '1,60d' mag${1}.txt > mag1.txt #deletes unecessary rows above the data
...
sed '1,59d' absmag${1}.txt > absmag1.txt #deletes unecessary rows above the data
...
sed '1,62d' swepam${1}.txt > swepam1.txt #deletes unecessary rows above the data
...
sed '1,68d' windswe${1}.txt > windswe1.txt #deletes unecessary rows above the data
